...
# Config 
class Config(object):
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "8040471417:AAF_GyFYbrznYZJ-_7RzYkOVdnVNS8HAoSk")
    API_ID = int(os.environ.get("API_ID",  "26524567"))
    API_HASH = os.environ.get("API_HASH", "444dfa80ab85a0fd32d1246966993a34")
